...
#include "../qt_models_and_views/coats_widget.h"
#include "../qt_models_and_views/coats_table_model.h"
...
private:
    ...
    QHBoxLayout *admin_undo_redo_layout{};
    ...
    QPushButton *user_remove_from_cart_button{};
    QPushButton *user_open_basket_button{};
    // The right side of the user mode window contains the "Shopping Basket" part (title + list + "Total" label)
    ...
    QHBoxLayout *user_label_layout{};
    QLabel *user_basket_total_label{};
    QPushButton *user_undo_button{};
    QPushButton *user_redo_button{};
    QPushButton *user_open_basket_table_view_button{};
    ...
    // ===== FOR THE TABLE VIEW =====
    // ==============================
    CoatsTableModel* coats_table_model{};
    CoatsWidget* coats_widget{};

private:
    void init_gui();

    void gui_show_shopping_basket_table_view();

    void gui_update_shopping_basket_table_view_width();
    ...
    int get_selected_index_from_shopping_basket_list() const;
    ...
    void gui_remove_coat_from_shopping_cart();
    ...
    void gui_deselect_user_shopping_basket_list_on_double_click(QListWidgetItem * itemClicked);
    ...
    void rewrite_current_filtered_coat();
...
public slots:
    ...
    void populate_shopping_basket_list();

    void refresh_current_filtered_coat();
