...
public:
    ...
    /*
        ...
        Input: reference to a trench coat.
        Return: the removed trench coat, if it was found in the repository
        Throws: RepositoryException, if the given trench coat is not in the repository
     */
    virtual TrenchCoat remove_trench_from_repo(TrenchCoat &t) = 0;

    /*
        Update a trench coat from the repository.
        Input: reference to a trench coat.
        Return: the old version of the updated trench coat, if it was found in the repository
        Throws: RepositoryException, if the given trench coat is not in the repository
     */
    virtual TrenchCoat update_trench_in_repo(TrenchCoat &t) = 0;
    ...
    /*
        Remove all the elements from the repository.
     */
    virtual void clear_repository() = 0;
};
