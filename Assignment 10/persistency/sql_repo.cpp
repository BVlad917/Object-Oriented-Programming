...
TrenchCoat SQLRepo::remove_trench_from_repo(TrenchCoat &t) {
    std::string size_copy = t.get_trench_size(), colour_copy = t.get_trench_colour();
    TrenchCoat removed_coat = this->find_trench_coat(size_copy, colour_copy);
...
TrenchCoat SQLRepo::update_trench_in_repo(TrenchCoat &t) {
    std::string size_copy = t.get_trench_size(), colour_copy = t.get_trench_colour();
    TrenchCoat removed_coat = this->find_trench_coat(size_copy, colour_copy);
